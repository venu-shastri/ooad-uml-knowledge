...
- ex:-  **`Cluster uses/holds GPS Sensors`** , **`Camera uses/Contains Imager`** , **`OS uses/ Processors`** , **`Radar uses Antenna`**
- Association 
	- Associated
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNzE3MzIyMTIsMTY4MDk0ODIwNywxMz
YzNzM5OTgwLC0yMzA2NTQxXX0=
-->